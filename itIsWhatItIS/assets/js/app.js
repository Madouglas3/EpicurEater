...
//			var m = $("<p>").text("Placeid: " + results[i].place_id);
			...
			//Buttons
			var buttons = '<div>';
			buttons += '<div class="wrap">';
			buttons += '<div>';
			buttons += '<button type="button" id="button1" class="button blue" value="Add To Favorites">Add To Favorites</button>';
			buttons += '</div>';
			buttons += '<div>';
			buttons += '<button type="button" id="button2" class="button blue" value="Read More...">Read More...</button>';
			buttons += '</div>';
			buttons += '</div>';
			buttons += '</div>';
			console.log(buttons)
